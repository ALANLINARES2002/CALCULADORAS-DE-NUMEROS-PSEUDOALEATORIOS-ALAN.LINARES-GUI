...
class MultiplicadorConstanteApp:
    def __init__(self, root):
        ...
        self.root.configure(bg="#FFD166")  # Naranja claro
        ...
        # Colores
        bg_naranja = "#FFD166"     # Fondo principal
        texto_negro = "#2E2E2E"    # Texto oscuro
        boton_naranja = "#FF8C00"  # Botones (naranja fuerte)
        blanco = "white"

        # Configurar estilos
        style.configure("TButton", background=boton_naranja, foreground=blanco, font=("Arial", 10))
        style.map("TButton", background=[('active', '#CC6600')])
        ...
        style.map("Treeview.Heading", background=[('active', '#CC6600')])
    ...
    def create_widgets(self):
        ...
        # Frame para entradas
        input_frame = tk.Frame(self.root, bg="#FFD166")
        ...
        # Botones inferiores
        button_frame = tk.Frame(self.root, bg="#FFD166")
