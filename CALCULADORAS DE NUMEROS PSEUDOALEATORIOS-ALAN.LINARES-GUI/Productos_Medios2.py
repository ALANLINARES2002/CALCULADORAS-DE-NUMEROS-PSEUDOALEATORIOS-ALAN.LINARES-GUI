...
class ProductosMediosApp:
    def __init__(self, root):
        ...
        self.root.configure(bg="#2E7D32")  # Verde bosque (fondo principal)
        ...
        # Colores
        bg_verde_bosque = "#2E7D32"   # Fondo principal (verde bosque)
        verde_boton = "#388E3C"       # Botones y encabezados (verde más claro)
    ...
    def create_widgets(self):
        ...
        # Frame para entradas
        input_frame = tk.Frame(self.root, bg="#2E7D32")
        ...
        # Botones inferiores
        button_frame = tk.Frame(self.root, bg="#2E7D32")
        ...
        prueba_frame = tk.Frame(self.root, bg="#2E7D32")
    ...
    def prueba_medias(self):
        ...
        ventana_prueba.configure(bg="#2E7D32")  # Verde bosque

        # Estilo
        style = ttk.Style()
        style.theme_use('clam')
        style.configure("TButton", background="#388E3C", foreground="white", font=("Arial", 10))
        style.map("TButton", background=[('active', '#1B5E20')])
